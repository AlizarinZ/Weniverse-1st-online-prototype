...
// measure mic level of each player? 
let mic;
...
function addClient(_id) {
	...
	let _aura = new THREE.Mesh(
		new THREE.SphereGeometry(7, 0.1, 0.1),
		new THREE.MeshPhongMaterial( { color: 0x000000, specular: 0x666666, emissive: 0x660066, shininess: 10, opacity: 0.2, transparent: true } )
	);
	_aura.position.set(0, 0, 0);
	...
	// _aura.add(_audioSource);

	// add mesh to scene
	glScene.scene.add(_aura);
